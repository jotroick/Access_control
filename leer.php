...
<body>
<table width="566" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">  <tr>
    ...
    <td align="left" valign="bottom"><table border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      <tr>        <td width="8" align="left" valign="top" background="img/izq.jpg"><img name="izq" src="img/izq.jpg" width="8" height="16" border="0" id="izq" alt="fondo" /></td>
        <td colspan="2" align="left" valign="bottom" class="textogris"><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">          <tr class="textotablas">
            <td align="left" valign="top"><p align="center"><strong>BIENVENIDO ESTE ES EL REGISTRO DE USUARIOS</strong></p></td> </tr> </table>
          <br />          </td>
      ...
      <tr>        <td align="left" valign="bottom" background="img/izq.jpg">&nbsp;</td>
...
?></td>
  ...
  <tr>    <td align="left" valign="top"><img src="img/footerleer.jpg" alt="company" name="cabezote" width="566" height="28" border="0" usemap="#cabezoteMap" id="cabezote" /></td>  </tr>
  <tr class="textofooter">
    <td align="center" valign="top" class="textofooter">Josafat Piraquive Triana  Ingenieria Electronica<br />    Proyecto de grado Universidad Nacional De Colombia<br />
